import{c as a,d as o,f as n}from"./script-_KeQWcTo.js";class i{cardHolder;patsArr;constructor(e){this.cardHolder=document.querySelector(e),this.patsArr=[],this.init()}init(){this.conectDB()}async conectDB(){try{const e=a(o,"pats");(await n(e)).forEach(s=>{const r=s.data();this.patsArr.push({id:s.id,img:r.img||"",imgWebP:r.imgWebP,name:r.name||"No Name",shortInfo:r.shortInfo||"",view:r.view||"",owner:r.owner||""})}),this.renderPat(this.patsArr)}catch(e){console.error(e)}}renderPat(e){this.cardHolder.innerHTML="",e.forEach(t=>{if(!t.owner){const s=`
